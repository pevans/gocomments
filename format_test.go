...
`,
		...
		{
			name:       "generated file not reformatted",
			lineLength: 50,
			tabLength:  4,
			input: `package main
...
// This is a very long comment that would normally be wrapped but the file is generated
func example() {}
`,
			want: `package main
...
`,
		...
		{
			name:       "generated file with reversed order not reformatted",
			lineLength: 50,
			tabLength:  4,
			input: `package main
...
`,
		...
		{
			name:       "file with only 'Code generated' still formatted",
			lineLength: 50,
			tabLength:  4,
			input: `package main
...
// This is a very long comment that should be wrapped because it only has one of the magic strings
func example() {}
`,
			want: `package main
...
// wrapped because it only has one of the magic
// strings
func example() {}
`,
		},
		{
			name:       "file with only 'DO NOT EDIT' still formatted",
			lineLength: 50,
			tabLength:  4,
			input: `package main
...
`,
		...
		{
			name:       "file with strings in separate comments still formatted",
			lineLength: 50,
			tabLength:  4,
			input: `package main
...
// This is a very long comment that should be wrapped because the strings are in different comment lines
func example() {}
`,
			want: `package main
...
// This is a very long comment that should be
// wrapped because the strings are in different
// comment lines
func example() {}
`,
		},
